...
import { WorkflowDefinition, WorkflowStep, WorkflowContext, WorkflowStepResult } from './workflow';
...
Provide your plan and explain the reasoning behind each change.`;
                ...
                try {
                    ...
                    logger.error('Failed to generate refactoring plan:', error);
                    return {
                        success: false,
...
Generate the refactored code as a unified diff patch.`;
                ...
                try {
                    ...
                    logger.error('Failed to execute refactoring:', error);
                    return {
                        success: false,
        ...
        },
        {
            ...
            async execute(context: WorkflowContext): Promise<WorkflowStepResult> {
                ...
                try {
                    ...
                    logger.error('Failed to save documentation:', error);
                    return {
                        success: false,
...
export const workflows = {
    codeAnalysis: codeAnalysisWorkflow,
