...
export function createDocumentQAWorkflow(
    ...
    const documentRetrievalTool = createDocumentRetrievalTool();
    
    const documentRetrievalNode = LangGraph.createToolNode(
        'document-retrieval',
        'Document Retrieval',
        documentRetrievalTool
    );
    
    const informationExtractionNode: GraphNode = {
    ...
    const answerGenerationNode: GraphNode = {
 ...
 */
export function createCodeRefactoringWorkflow(
    id: string,
    name: string,
    description: string,
    agent: Agent
    ...
    const codeAnalysisNode: GraphNode = {
        id: 'code-analysis',
        type: 'agent',
        name: 'Code Analysis',
        agent,
    ...
    const refactoringPlanNode: GraphNode = {
        id: 'refactoring-plan',
        type: 'agent',
    ...
    const refactoringImplementationNode: GraphNode = {
 ...
 */
export function createDebuggingWorkflow(
    id: string,
    name: string,
    description: string,
    agent: Agent
    ...
    const errorAnalysisNode: GraphNode = {
        id: 'error-analysis',
        type: 'agent',
        name: 'Error Analysis',
        agent,
    ...
    const solutionGenerationNode: GraphNode = {
    ...
    const explanationNode: GraphNode = {
        id: 'explanation',
        type: 'agent',
        name: 'Explanation',
        agent,
